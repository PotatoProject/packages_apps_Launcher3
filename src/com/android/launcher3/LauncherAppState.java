...
import static com.android.launcher3.Icons.NOTIFICATION_BADGING;
...
public class LauncherAppState {
    ...
    private LauncherAppState(Context context) {
        ...
        setSearchAppAvailable(PotatoUtils.isPackageInstalled(context, LauncherTab.SEARCH_PACKAGE));
        setCalendarAppAvailable(PotatoUtils.isPackageInstalled(context, "com.google.android.calendar"));
